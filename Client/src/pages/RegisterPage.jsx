...
const RegisterPage = () => {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    const newUser = { name, email, password, adminCode };
        ...
        <Col xs={12} md={6}>
          ...
          <Form onSubmit={onSubmit}>
            ...
            <Form.Group className="mb-3" controlId="formBasicAdminCode">
              ...
              <Form.Control type="text" placeholder="Optional: Enter code for admin registration" name="adminCode" value={adminCode} onChange={onChange} />
            </Form.Group>
